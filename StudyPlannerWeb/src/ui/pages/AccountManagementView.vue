...
<template>
  <div
    class="w-full h-full flex flex-col p-4 sm:p-6 bg-gray-50 rounded-xl shadow-md text-sm"
  >
    <!-- Header -->
    <div
      class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between mb-4 gap-3"
    >
    ...
    >
      <div class="overflow-x-auto">
        <table
          class="w-full min-w-[700px] text-left text-sm text-gray-600 table-auto border border-gray-300"
        >
          <thead
    ...
    <!-- Pagination -->
    <div
      class="flex flex-col sm:flex-row justify-center items-center gap-2 sm:space-x-3 mt-4 text-sm shrink-0"
    >
      <button
        @click="goPrevPage"
      ...
      <span
        class="px-3 py-1 rounded-full bg-blue-100 text-blue-800 font-medium shadow-sm text-center"
      >
    ...
    >
      <div
        class="bg-white rounded-2xl shadow-xl w-[95%] sm:w-full sm:max-w-lg p-6 relative border border-gray-200"
      >
        <button
